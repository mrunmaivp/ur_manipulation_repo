...
# point.positions = [1.7557871558221327, 0.1478664065801399, -0.1833677340536805, -2.421393053132419, -0.0007645683223346205, 2.636810320671023, -2.418337605783124]
point.positions = [0.0, -1.57, 1.57, 0.0, -1.57, 2.814843411405562]
# point.positions = [math.sin(self.time), math.sin(self.time), math.sin(self.time),
                                # math.sin(self.time), math.sin(self.time), math.sin(self.time)]
